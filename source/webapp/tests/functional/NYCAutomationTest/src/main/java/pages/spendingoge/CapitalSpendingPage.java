		...
		public static int GetTransactionCount() {
	  	...
	  	public static void GoToBottomNavSpendinglink() {
	       ...
	       //  WebElement tabAnchor = tab.findElement(By.tagName("a"));
	          //  WebElement tabAnchor = tab.findElement(By.linkText("Capital Spending"));
	        	            
	           WebElement tabAnchor =Driver.Instance.findElement(By.xpath("/html/body/div[2]/div[3]/div[2]/div[1]/div/div/div/div[1]/div/div/div/div[4]/div/div[3]/div/div/div[1]/div/table/tbody/tr/td[3]/div[1]/a"));
