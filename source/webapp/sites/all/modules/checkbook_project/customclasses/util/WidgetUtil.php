...
class WidgetUtil
{
    ...
    /** Returns label for export file for the given label alias */
    ...
    /** Returns label for widgets for the given label alias */
    ...
    static $labels = array(
        ...
        "budget_code_category"=>"Budget<br>Category",
        "budget_code_code"=>"Budget<br>Code",
