...
*/
    ...
    $year1 = _getYearValueFromID(RequestUtilities::get('year'));
    $year2 = _getYearValueFromID(RequestUtilities::get('year')+1);
    $year3 = _getYearValueFromID(RequestUtilities::get('year')+2);
