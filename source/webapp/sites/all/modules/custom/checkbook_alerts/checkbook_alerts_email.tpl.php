...
To unsubscribe to this alert click here: <?=$conf['check_book']['data_feeds']['site_url'].'alert/unsubscribe/'.$alert->checkbook_alerts_sysid.md5($alert->checkbook_alerts_sysid.$alert->label.$alert->recipient); ?>
