...
if (module_exists('widget_highcharts')){
    drupal_add_js(drupal_get_path('module', 'widget_highcharts') .'/highcharts/9.3.2/code/highcharts.js', array('group'=>JS_LIBRARY,'weight'=>-1));
    ...
    drupal_add_js(drupal_get_path('module', 'widget_highstock') .'/highstock/9.3.2/code/highstock.js');
