...
if (module_exists('widget_highcharts')){
    drupal_add_js(drupal_get_path('module', 'widget_highcharts') .'/highcharts/8.1.0/code/highcharts.js', array('group'=>JS_LIBRARY,'weight'=>-1));
    ...
    drupal_add_js(drupal_get_path('module', 'widget_highstock') .'/highstock/8.1.0/code/highstock.js');
