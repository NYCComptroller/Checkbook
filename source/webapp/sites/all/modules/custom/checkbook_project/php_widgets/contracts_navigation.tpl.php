...
*/
if($mwbe_amount  == 0){	
	$mwbe_link = l('<div><div class="drop-down-menu-triangle"></div><span class="nav-title">' . RequestUtil::getDashboardTopNavTitle("mwbe") . '</span><br>&nbsp;'. custom_number_formatter_format(0 ,1,'$') . '</div>','',$options_disabled);
}else{	
	$mwbe_link = l('<div><div class="drop-down-menu-triangle"></div><span class="nav-title">' . RequestUtil::getDashboardTopNavTitle("mwbe") . '</span><br>&nbsp;'. custom_number_formatter_format($mwbe_amount ,1,'$') . '</div>',$mwbe_active_domain_link,$options);
}


if($svendor_amount  == 0){	
	$subvendors_link = l('<div><div class="drop-down-menu-triangle"></div><span class="nav-title">' .RequestUtil::getDashboardTopNavTitle("subvendor")  .'</span><br>&nbsp;'. custom_number_formatter_format(0 ,1,'$') . '</div>','',$options_disabled);	
}else{
	$subvendors_link = l('<div><div class="drop-down-menu-triangle"></div><span class="nav-title">' .RequestUtil::getDashboardTopNavTitle("subvendor")  .'</span><br>&nbsp;'. custom_number_formatter_format($svendor_amount ,1,'$') . '</div>',$svendor_active_domain_link ,$options);
}
