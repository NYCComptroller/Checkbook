...
if($spending_amount  == 0 || (($has_vendor_parameter && Dashboard::isMWBE()) && (!$contracts_advanced_search && !$spending_advanced_search && $current_domain != 'contracts'))){
...
if ($contract_amount > 0) {
  if(($has_vendor_parameter && Dashboard::isMWBE()) && (!$contracts_advanced_search && !$spending_advanced_search) && $current_domain != 'spending') {
