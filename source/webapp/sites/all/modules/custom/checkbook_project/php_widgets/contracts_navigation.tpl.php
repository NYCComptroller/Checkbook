{
    ...
    if(!preg_match('/smnid/',$_GET['q']) && ( 
    	...
    	unset($node->widgetConfig->model->series[6]->seriesURLParamMap->mwbe);
    	    log_error($node->widgetConfig->model->series);
    }
        ...
        "series": [
            ...
            },
           {
            ...
            }  ,
            {
               ...
               "seriesURLParamMap":{"subvendor":"vendor_id","vendor":"prime_vendor_id","calyear":"fiscal_year_id","year":"fiscal_year_id","agency":"agency_id","yeartype":"type_of_year",
               	"mwbe":"minority_type_id"},
