...
<table id="table_<?php echo widget_unique_identifier($node) ?>" class="<?php echo $node->widgetConfig->gridConfig->html_class ?>">
    <thead>
    <?php
        echo "<tr><th class='text'>" . WidgetUtil::generateLabelMapping("agency_name") . "</th>
    ...
    <?php
            foreach ($node->data as $datarow) {                
                echo "<tr>";
                   echo '<td>' . $datarow['agency_agency_agency_name'] . '</td>';
                        ...
                        "aoColumnDefs": [
                            {
                                ...
                                "mDataProp": function ( source, type, val ) {
                                    if (type == "set") {                                        
                                        source.agency_agency_agency_name = val;
                                        source.agency_agency_agency_name_display = "<div>" + val + "</div>" ;
                                        return;
                                    }else if (type == "display") {
                                        return source.agency_agency_agency_name_display;
                                    }else if (type == "sort") {
                                        return source.agency_agency_agency_name;
                                    }
                                    return source.agency_agency_agency_name;
                                },
                                "asSorting": [ "desc","asc" ],
