                        ...
                        "aoColumnDefs": [
                            {
                                ...
                                "mDataProp": function ( source, type, val ) {
                                    if (type == "set") {
                                        source.department_name_department_name = val;
                                        source.department_name_department_name_display = "<div>" + val + "</div>";
                                        return;
                                    }else if (type == "display") {
                                        return source.department_name_department_name_display;
                                    }else if (type == "sort") {
                                        return source.department_name_department_name;
                                    }
                                    return source.department_name_department_name;
                                },
                                "asSorting": [ "desc","asc" ],
