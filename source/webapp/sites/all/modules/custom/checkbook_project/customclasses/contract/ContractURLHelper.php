...
class ContractURLHelper
{
   ...
   * @return null|string
   */
  public static function prepareExpenseContractLink($row, $node, $parent = false, $original_agreement_id = null){
    $link = NULL;
   ...
   * @return null|string
   */
  public static function preparePendingContractLink($row, $node){
   ...
   * @return string
   */
    public static function prepareExpandLink($row, $node){
