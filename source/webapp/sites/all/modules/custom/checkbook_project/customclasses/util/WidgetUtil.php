...
class WidgetUtil
{
    ...
    static function getLabel($labelAlias){
        ...
        $labelAliases_br = array("spent_to_date", "original_amount", "current_amount", "dollar_diff", "percent_diff", "no_of_contracts", "num_sub_contracts", "ytd_spending", "total_contract_amount", "percent_spending");
