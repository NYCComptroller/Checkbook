...
class WidgetUtil
{
    ...
    static $labels = array(
        ...
        "line_current_amount" => "Line<br/>Current Amount",
        "line_original_amount" => "Line<br/>Original Amount",
        "line_spend_to_date" => "Line<br/>Spent To<br/>Date",
        ...
        "contract_current_amount"=>"Contract<br/>Current Amount",
        "contract_original_amount"=>"Contract<br/>Original Amount",
        "contract_spend_to_date"=>"Contract<br/>Spend to Date",
