...
<table id="table_<?php echo widget_unique_identifier($node) ?>" class="<?php echo $node->widgetConfig->html_class ?>">
    ...
    <tr class="first-row">
        ...
        <th colspan="3" class="centrig bb"><div>Percent of Levy through June 30, 2014</div></th>
        <th rowspan="2" class="number"><div class="trendCen" >Uncollected<br>Balance<br/> June 30, 2014</div></th>
    </tr>
    <tr class="second-row">
...
<p>NOTES: Total uncollected balance at June 30, 2014 less allowance for uncollectible amounts equals net realizable amount (real estate taxes receivable).</p>
