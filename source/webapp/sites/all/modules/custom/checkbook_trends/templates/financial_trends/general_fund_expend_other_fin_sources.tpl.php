...
if(preg_match('/featuredtrends/',$_GET['q'])){
  $links = array(l(t('Home'), ''), l(t('Trends'), 'featured-trends'),l(t('General Fund Revenues and General Fund Expenditures'), 'featured-trends'),'General Fund Expenditures and Other Financing Uses Details');
...
<a class="trends-export" href="/export/download/trends_general_fund_expend_other_fin_sources_csv?dataUrl=/node/<?php echo $node->nid ?>">Export</a>
<table class="fy-ait">
  <tbody>
  <tr>
    <td style="width:350px;padding:0;"><div>&nbsp;</div></td>
