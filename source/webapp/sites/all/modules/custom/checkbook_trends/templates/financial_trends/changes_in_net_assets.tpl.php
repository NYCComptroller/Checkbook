...
<a class="trends-export"
   href="/export/download/trends_changes_in_net_assets_csv?dataUrl=/node/<?php echo $node->nid ?>">Export</a>
<table class="fy-ait">
    <tbody>
    <tr>
        ...
        <td class="bb">
            <div>Fiscal Year<br>(Amounts in Thousands)</div>
        </td>
    </tr>
    </tbody>
</table>
<table id="table_<?php echo widget_unique_identifier($node) ?>" style='display:none'
       class="trendsShowOnLoad <?php echo $node->widgetConfig->html_class ?>">
    <?php
