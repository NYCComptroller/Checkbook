...
<table id="table_<?php echo widget_unique_identifier($node) ?>" style='display:none' class="trendsShowOnLoad <?php echo $node->widgetConfig->html_class ?>">
    ...
    <div class="footnote">
    <p>Notes:</p>
      <p>(1)   <i>The Legal Debt Margin and the Net Debt Applicable to the Debt Limit</i> as a <i>Percentage of the Debt Limit</i> are recalculated on July 1, the first day of each City fiscal year,
        based on the new assessed value in  accordance with the new year’s enacted tax fixing resolution.  For fiscal year 2019, beginning July 1, 2018, the <i>Legal Debt Margin</i> and the <i>Net Debt Applicable to the Debt Limit as a Percentage of the Debt Limit</i> are $37,235,767 and 64.95%, respectively.</p>
    <p>(2)   A five-year average of full valuations of taxable real estate from the Resolutions of the Council Fixing the Tax Rates for the fiscal year beginning on July 1, 2018 and ending June 30, 2019.</p>
    ...
    <p>(6)   Obligations for water supply and certain obligations for rapid transit are excluded pursuant to the State Constitution and in accordance with provisions of the State Local Finance Law. Resources of the General Debt Service Fund applicable to non-excluded debt and debt service appropriations for the redemption of such debt are deducted from the non-excluded funded debt to arrive at the funded debt within the debt limit.</p>
    </div>
<?php
