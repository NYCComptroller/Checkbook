...
echo "\n"."\n".
     ...
     "\n"."\n".'"'."(1) The Legal Debt Margin and the Net Debt Applicable to the Debt Limit as a Percentage of the Debt Limit are recalculated on July 1, the first day of each City fiscal year, based on the new assessed value
      ...
      to the Debt Limit as a Percentage of the Debt Limit are $34,211,662 and 65.18%, respectively.".'"'.
     "\n"."\n".'"'."(2) A five-year average of full valuations of taxable real estate from the Resolutions of the Council Fixing the Tax Rates for the fiscal year beginning on July 1, 2016 and ending on June 30, 2017.".'"'.
