...
<?php
        if (isset($node->data) && is_array($node->data)) {
            foreach ($node->data as $datarow) {
                echo "<tr>";
                   echo '<td>' . $datarow['expenditure_type_description_expenditure_type_description'] . '</td>';
                        ...
                        "aoColumnDefs": [
                            {
                                ...
                                "mDataProp": function ( source, type, val ) {
                                    if (type == "set") {
                                        source.expenditure_type_description_expenditure_type_description = val;
                                        source.expenditure_type_description_expenditure_type_description = "<div>" + val + "</div>";
                                        return;
                                    }else if (type == "display") {
                                        return source.expenditure_type_description_expenditure_type_description;
                                    }else if (type == "sort") {
                                        return source.expenditure_type_description_expenditure_type_description;
                                    }
                                    return source.expenditure_type_description_expenditure_type_description;
