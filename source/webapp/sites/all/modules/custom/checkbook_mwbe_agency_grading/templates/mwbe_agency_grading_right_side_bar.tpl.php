			...
			<div class="legend">
		    	...
		    	<form action="" name="mglegend">
					...
					<tbody><tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" checked="" name="aa_mwbe"></td>
					...
					<tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" checked="" name="ba_mwbe"></td>
					...
					<tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" checked="" name="ha_mwbe"></td>
					...
					<tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" checked="" name="w_mwbe"></td>
					...
					<tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" name="n_mwbe"></td>
					...
					<tr class="legend_entry">
						<td><!-- <span name="lengend_checkbox"></span> --><input type="checkbox" name="io_mwbe"></td>
