...
function _checkbook_smart_search_get_results(){
    ...
    if($search_terms[0] == ""){
        ...
        $search_text = _checkbook_smart_search_escapeSolrValue($search_terms[0]); // encode the string
        $search_text = ucwords(strtolower($search_text)); // uppercase the first letter of each word
    }
