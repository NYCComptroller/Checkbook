  ...
  <div<?php print $content_attributes; ?>>
    <div class="branding-data clearfix">
      ...
      <div class="comptroller">
        <a class="logo" href="https://comptroller.nyc.gov/"><img src="<?php print base_path(); ?>sites/all/themes/checkbook3/images/nyc-comptroller.png" alt="New York City Comptroller - Scott M. Stringer" width="245" height="40" /></a>
      </div>
      <?php endif; ?>
