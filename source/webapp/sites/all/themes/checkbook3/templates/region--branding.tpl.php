  ...
  <div<?php print $content_attributes; ?>>
    <div class="branding-data clearfix">
      ...
      <div class="comptroller">
        <a class="logo" href="http://www.comptroller.nyc.gov/"><img src="<?php print base_path(); ?>sites/all/themes/checkbook3/images/comptrollerlogo.jpeg" alt="New York City Comptroller - Scott M. Stringer" /></a>
      </div>
      <?php endif; ?>
