...
cd /home/gpadmin/POSTGRESQL/Checkbook_ogent/KETTLE_JOB/PreProcessing_DataFiles/
...
rm -f goodfile.txt
rm -f badfile.txt
dirName="/home/gpadmin/POSTGRESQL/Checkbook_ogent/GPFDIST_DIR/datafiles/"
fileName=$dirName$2
if [ $1 == "COAAgency" ] ; then	
	...
	./removeMalformedRevenueBudgetRecords.sh $fileName
        ...
        ./validateEDCFile.awk $fileName

elif [ $1 == "NYCTDC" ] ; then
        ./validateTDCFile.awk $fileName
fi
