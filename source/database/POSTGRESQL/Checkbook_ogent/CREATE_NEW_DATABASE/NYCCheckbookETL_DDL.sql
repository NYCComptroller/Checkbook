...
CREATE FOREIGN TABLE foreign_tbl_coa_agency_feed(
	...
	OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_agency_feed.txt', format 'text', delimiter '|'  );
...
CREATE TABLE ext_stg_coa_agency_feed(
  ...
  CREATE FOREIGN TABLE foreign_tbl_coa_department_feed(
	...
	OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_department_feed.txt', format 'text', delimiter '|'  );
 ...
 CREATE FOREIGN TABLE foreign_tbl_coa_expenditure_object_feed(
	...
	OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_expenditure_object_feed.txt', format 'text', delimiter '|'  );
...
CREATE TABLE ext_stg_coa_expenditure_object_feed(
   ...
   CREATE FOREIGN TABLE foreign_tbl_coa_location_feed(
	...
	OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_location_object_feed.txt', format 'text', delimiter '|'  );
 ...
 CREATE TABLE ext_stg_coa_location_feed(
  ...
  CREATE FOREIGN TABLE foreign_tbl_coa_object_class_feed(
	...
	OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_object_class_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_revenue_category_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_revenue_class_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_revenue_source_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_budget_code_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/COA_funding_class_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/MAG_feed_Header.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/MAG_feed_Vendor.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/MAG_feed_Detail.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/FMSV_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_CT_Header.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_CT_Vendor.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_CT_Detail.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_CT_Accounting_line.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_PO_Header.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_PO_Vendor.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_PO_Detail.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_PO_Accounting_line.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_DO_Header.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_DO_Vendor.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/CON_feed_DO_Accounting_line.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/FMS_feed_Header.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/FMS_feed_Vendor.txt', format 'text', delimiter '|'  );	
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/FMS_feed_Accounting_line.txt', format 'text', delimiter '|'  );	
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/BUDGET_feed.txt', format 'text', delimiter '|'  );	
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/Revenue_feed.txt', format 'text', delimiter '|'  );	
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/revenue_budget.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/PMS_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/PMS_summary_feed.txt', format 'text', delimiter '|'  );
...
OPTIONS ( filename '/vol2share/NYC/FEEDS/POSTGRESQL_OGE/GPFDIST_DIR/datafiles/OAISIS_feed.txt', format 'text', delimiter '|'  );
