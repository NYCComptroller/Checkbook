...
CREATE TEMPORARY TABLE tmp_ct_master_agreements_rfed(original_master_agreement_id bigint, status_flag char(1), fiscal_year smallint, rfed_amount numeric(16,2), maximum_contract_amount numeric(16,2)) ;
