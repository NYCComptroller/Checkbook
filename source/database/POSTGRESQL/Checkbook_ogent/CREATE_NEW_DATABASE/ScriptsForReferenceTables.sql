COPY etl.ref_data_source FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/ref_data_source.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_column_mapping FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/ref_column_mapping.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_validation_rule FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/ref_validation_rule.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_file_name_pattern FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/ref_file_name_pattern.csv' CSV HEADER QUOTE as '"';

COPY etl.aggregate_tables FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/widget_aggregate_tables_edc.csv' CSV HEADER QUOTE as '"';
...
COPY etl.stg_funding_class FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/FundingClass.txt' DELIMITER AS '|' ESCAPE '~' FILL MISSING FIELDS;		
...
COPY etl.stg_award_method FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/AwardMethod.csv' CSV QUOTE as '"' ;
...
COPY etl.stg_agreement_type FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/AgreementType.csv' DELIMITER AS ',' ;
...
COPY etl.stg_award_category FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/AgreementCategory.csv' CSV QUOTE as '"' ;
...
COPY etl.stg_award_category_industry FROM '/home/gpadmin/POSTGRESQL/Checkbook_ogent/CREATE_NEW_DATABASE/AgreementIndustryCategory.csv' CSV QUOTE as '"' ;
...
INSERT INTO ref_agency(agency_id, agency_code, agency_name, original_agency_name, created_date, agency_short_name, is_display, is_oge_agency) VALUES(nextval('seq_ref_agency_agency_id'),'z81','VENDOR MMMWMFKKEA','VENDOR MMMWMFKKEA', now()::timestamp, 'EDC AGENCY','Y', 'Y');
...
SELECT nextval('seq_ref_department_department_id'),'110' as department_code, 'EDC DEPT1' as department_name, 'EDC DEPT1' as department_short_name,b.agency_id,c.fund_class_id,2013 as fiscal_year,now()::timestamp, 'EDC DEPT1' as department_name
