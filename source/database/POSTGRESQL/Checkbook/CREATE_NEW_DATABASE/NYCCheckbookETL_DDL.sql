...
CREATE SERVER postgresql_file_server FOREIGN DATA WRAPPER file_fdw;
...
CREATE FOREIGN TABLE foreign_tbl_coa_agency_feed(
	agency_code VARCHAR,
	agency_name VARCHAR,
	col3	    VARCHAR,
...
CREATE TABLE ext_stg_coa_agency_feed(
  ...
  CREATE FOREIGN TABLE foreign_tbl_coa_department_feed(
 	agency_code VARCHAR,
 ...
 CREATE FOREIGN TABLE foreign_tbl_coa_expenditure_object_feed(
  	col1 VARCHAR,
  	fiscal_year varchar,
...
CREATE TABLE ext_stg_coa_expenditure_object_feed(
   ...
   CREATE FOREIGN TABLE foreign_tbl_coa_location_feed(
   	agency_code varchar(20),
	location_code varchar(4),
	location_name varchar(60),
	location_short_name varchar(16),
	upper_case_name varchar(60),
	col6 varchar(100),
	col7 varchar(100),
	col8 varchar(100),
	col9 varchar(100),
 ...
 CREATE TABLE ext_stg_coa_location_feed(
  ...
  CREATE FOREIGN TABLE foreign_tbl_coa_object_class_feed(
 	doc_dept_cd varchar,
...
CREATE FOREIGN TABLE foreign_tbl_coa_revenue_category_feed
(
...
CREATE FOREIGN TABLE foreign_tbl_coa_revenue_class_feed
(
DOC_DEPT_CD character varying,
...
CREATE FOREIGN TABLE foreign_tbl_coa_revenue_source_feed(
doc_dept_cd character varying,
...
CREATE FOREIGN TABLE foreign_tbl_coa_budget_code_feed
(
fy character varying,
...
CREATE TABLE archive_agency (LIKE stg_agency) ;
ALTER TABLE archive_agency ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_agency (LIKE archive_agency) ;
...
CREATE TABLE archive_department (LIKE stg_department) ;
ALTER TABLE archive_department ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_department (LIKE archive_department) ;
...
CREATE TABLE archive_expenditure_object (LIKE stg_expenditure_object) ;
ALTER TABLE archive_expenditure_object ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_expenditure_object (LIKE archive_expenditure_object) ;
...
CREATE TABLE archive_location (LIKE stg_location) ;
ALTER TABLE archive_location ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_location (LIKE archive_location) ; 
...
CREATE TABLE archive_object_class (LIKE stg_object_class) ;
ALTER TABLE archive_object_class ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_object_class (LIKE archive_object_class) ; 
...
CREATE TABLE archive_revenue_category (LIKE stg_revenue_category) ;
ALTER TABLE archive_revenue_category ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_revenue_category (LIKE archive_revenue_category) ;
...
CREATE TABLE archive_revenue_class (LIKE stg_revenue_class) ;
alter table archive_revenue_class ADD COLUMN load_file_id bigint;


CREATE TABLE invalid_revenue_class (LIKE archive_revenue_class) ;
...
CREATE TABLE archive_revenue_source (LIKE stg_revenue_source) ;
ALTER TABLE archive_revenue_source ADD COLUMN load_file_id bigint;


CREATE TABLE invalid_revenue_source (LIKE archive_revenue_source) ;
...
CREATE TABLE archive_budget_code (LIKE etl.stg_budget_code) ;
ALTER TABLE archive_budget_code ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_budget_code (LIKE archive_budget_code) ;
...
CREATE FOREIGN TABLE foreign_tbl_funding_class
(
 doc_dept_cd varchar,
fy varchar,
...
CREATE TABLE etl.archive_funding_class (LIKE etl.stg_funding_class);
ALTER TABLE etl.archive_funding_class ADD COLUMN load_file_id bigint;


CREATE TABLE etl.invalid_funding_class (LIKE etl.archive_funding_class) ;
...
-- Start of MAG feed related tables
 ...
 CREATE FOREIGN TABLE foreign_tbl_mag_data_feed_header(
...
OPTIONS ( filename '/home/gpadmin/POSTGRESQL/Checkbook/GPFDIST/datafiles/MAG_feed_Header.txt', format 'text', delimiter '|'  );
	 ...
	 CREATE FOREIGN TABLE foreign_tbl_mag_data_feed_vendor(
record_type char(1),doc_cd varchar(8),doc_dept_cd varchar(20), doc_id varchar(20),doc_vers_no varchar,
	col6 varchar(100),col7 varchar(100),col8 varchar(100),col9 varchar(100),col10 varchar(100),
	col11 varchar,col12 varchar(100),col13 varchar,col14 varchar(100),col15 varchar(100),
	col16 varchar(255),col17 varchar(100),col18 varchar(100),col19 varchar(100),col20 varchar(255),
...
CREATE TABLE archive_mag_header (LIKE stg_mag_header) ;
ALTER TABLE archive_mag_header ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_mag_header (LIKE archive_mag_header) ;


CREATE TABLE archive_mag_award_detail (LIKE stg_mag_award_detail) ;
ALTER TABLE archive_mag_award_detail ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_mag_award_detail (LIKE archive_mag_award_detail) ;

CREATE TABLE archive_mag_vendor (LIKE stg_mag_vendor) ;
ALTER TABLE archive_mag_vendor ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_mag_vendor (LIKE archive_mag_vendor) ;

CREATE TABLE archive_mag_commodity (LIKE stg_mag_commodity) ;
ALTER TABLE archive_mag_commodity ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_mag_commodity (LIKE archive_mag_commodity) ;

-- End of MAG feed related tables

-- Start of FMSV related tables

 CREATE FOREIGN TABLE foreign_tbl_fmsv_data_feed(
 record_type char(1),
 doc_dept_cd varchar,
 vend_cust_cd varchar,
 bus_typ varchar,
 bus_typ_sta varchar,
 min_typ varchar,
 disp_cert_strt_dt varchar,
 cert_end_dt varchar,
...
CREATE TABLE archive_fmsv_business_type (LIKE stg_fmsv_business_type) ;
ALTER TABLE archive_fmsv_business_type ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_fmsv_business_type (LIKE archive_fmsv_business_type) ;
...
CREATE FOREIGN TABLE foreign_tbl_con_ct_data_feed_header(
	record_type char(1),
	doc_cd varchar(8),
...
CREATE FOREIGN TABLE foreign_tbl_con_ct_data_feed_vendor(
	record_type char(1),
	doc_cd varchar(8),
	doc_dept_cd varchar(20),
	doc_id varchar(20),
...
CREATE FOREIGN TABLE foreign_tbl_con_ct_data_feed_detail(
	record_type char(1),
	doc_cd varchar(8),
	doc_dept_cd varchar(20),
	doc_id varchar(20),
...
CREATE TABLE archive_con_ct_header (LIKE stg_con_ct_header) ;
ALTER TABLE archive_con_ct_header ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_ct_header (LIKE archive_con_ct_header) ;

CREATE TABLE archive_con_ct_award_detail (LIKE stg_con_ct_award_detail) ;
ALTER TABLE archive_con_ct_award_detail ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_ct_award_detail (LIKE archive_con_ct_award_detail) ;

CREATE TABLE archive_con_ct_vendor (LIKE stg_con_ct_vendor) ;
ALTER TABLE archive_con_ct_vendor ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_ct_vendor (LIKE archive_con_ct_vendor) ;

CREATE TABLE archive_con_ct_commodity (LIKE stg_con_ct_commodity) ;
ALTER TABLE archive_con_ct_commodity ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_ct_commodity (LIKE archive_con_ct_commodity) ;

CREATE TABLE archive_con_ct_accounting_line (LIKE stg_con_ct_accounting_line) ;
ALTER TABLE archive_con_ct_accounting_line ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_ct_accounting_line (LIKE archive_con_ct_accounting_line) ;

CREATE TABLE archive_con_po_header (LIKE stg_con_po_header) ;
ALTER TABLE archive_con_po_header ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_po_header (LIKE archive_con_po_header) ;

CREATE TABLE archive_con_po_award_detail (LIKE stg_con_po_award_detail) ;
ALTER TABLE archive_con_po_award_detail ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_po_award_detail (LIKE archive_con_po_award_detail) ;

CREATE TABLE archive_con_po_vendor (LIKE stg_con_po_vendor) ;
ALTER TABLE archive_con_po_vendor ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_po_vendor (LIKE archive_con_po_vendor) ;

CREATE TABLE archive_con_po_commodity (LIKE stg_con_po_commodity) ;
ALTER TABLE archive_con_po_commodity ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_po_commodity (LIKE archive_con_po_commodity) ;

CREATE TABLE archive_con_po_accounting_line (LIKE stg_con_po_accounting_line) ;
ALTER TABLE archive_con_po_accounting_line ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_po_accounting_line (LIKE archive_con_po_accounting_line) ;

CREATE TABLE archive_con_do1_header (LIKE stg_con_do1_header) ;
ALTER TABLE archive_con_do1_header ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_do1_header (LIKE archive_con_do1_header) ;

CREATE TABLE archive_con_do1_vendor (LIKE stg_con_do1_vendor) ;
ALTER TABLE archive_con_do1_vendor ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_do1_vendor (LIKE archive_con_do1_vendor) ;

CREATE TABLE archive_con_do1_commodity (LIKE stg_con_do1_commodity) ;
ALTER TABLE archive_con_do1_commodity ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_do1_commodity (LIKE archive_con_do1_commodity) ;

CREATE TABLE archive_con_do1_accounting_line (LIKE stg_con_do1_accounting_line) ;
ALTER TABLE archive_con_do1_accounting_line ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_con_do1_accounting_line (LIKE archive_con_do1_accounting_line) ;
...
CREATE FOREIGN TABLE foreign_tbl_fms_data_feed_header(
	record_type char(1),
	doc_cd varchar(8),
	doc_dept_cd varchar(4),
	doc_id varchar(20),
...
CREATE TABLE archive_fms_header (LIKE stg_fms_header) ;
ALTER TABLE archive_fms_header ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_fms_header (LIKE archive_fms_header) ;

CREATE TABLE archive_fms_vendor (LIKE stg_fms_vendor) ;
ALTER TABLE archive_fms_vendor ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_fms_vendor (LIKE archive_fms_vendor) ;

CREATE TABLE archive_fms_accounting_line (LIKE stg_fms_accounting_line) ;
ALTER TABLE archive_fms_accounting_line ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_fms_accounting_line (LIKE archive_fms_accounting_line) ;	
...
CREATE FOREIGN TABLE foreign_tbl_budget_feed
(
...
CREATE TABLE etl.archive_budget (LIKE etl.stg_budget) ;
ALTER TABLE etl.archive_budget ADD COLUMN load_file_id bigint;

CREATE TABLE etl.invalid_budget (LIKE etl.archive_budget) ;

----------------------------------------------------------------------------------------------------------------
/* Revenue data feed */

CREATE FOREIGN TABLE foreign_tbl_revenue(
...
CREATE TABLE archive_revenue (LIKE stg_revenue) ;
ALTER TABLE archive_revenue ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_revenue (LIKE archive_revenue) ;		


--------------------------------------------------------------------------------------------------------------------------------
/* Revenue budget data feed */

CREATE FOREIGN TABLE foreign_tbl_revenue_budget
(
  bfy varchar,
  fcls_cd varchar,
  dept_cd varchar,
...
CREATE TABLE etl.archive_revenue_budget (LIKE etl.stg_revenue_budget) ;
ALTER TABLE etl.archive_revenue_budget ADD COLUMN load_file_id bigint;



CREATE TABLE etl.invalid_revenue_budget (LIKE etl.archive_revenue_budget) ;
...
CREATE FOREIGN TABLE foreign_tbl_pms_data_feed(
...
CREATE TABLE archive_payroll (LIKE stg_payroll) ;
ALTER TABLE archive_payroll ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_payroll (LIKE archive_payroll) ;
...
CREATE FOREIGN TABLE foreign_tbl_pms_summary_data_feed(
...
CREATE TABLE archive_payroll_summary (LIKE stg_payroll_summary) ;
ALTER TABLE archive_payroll_summary ADD COLUMN load_file_id bigint;

CREATE TABLE invalid_payroll_summary (LIKE archive_payroll_summary) ;	
...
CREATE FOREIGN TABLE foreign_tbl_oaisis_feed(
...
CREATE TABLE ext_stg_oaisis_feed(
 ...
 CREATE TABLE archive_pending_contracts (LIKE stg_pending_contracts) ;
 ALTER TABLE archive_pending_contracts ADD COLUMN load_file_id bigint;
 
 CREATE TABLE invalid_pending_contracts (LIKE archive_pending_contracts) ;	
...
-- spending indexes on 05/29/2014
CREATE INDEX idx_doc_cd_stg_fms_header   ON    etl.stg_fms_header(doc_cd);
CREATE INDEX idx_doc_dept_cd_stg_fms_header   ON    etl.stg_fms_header(doc_dept_cd);
CREATE INDEX idx_doc_id_stg_fms_header   ON    etl.stg_fms_header(doc_id);
CREATE INDEX idx_doc_vers_no_stg_fms_header   ON    etl.stg_fms_header(doc_vers_no);
CREATE INDEX idx_uniq_id_stg_fms_header   ON    etl.stg_fms_header(uniq_id);


CREATE INDEX idx_doc_cd_stg_fms_vendor   ON    etl.stg_fms_vendor(doc_cd);
CREATE INDEX idx_doc_dept_cd_stg_fms_vendor   ON    etl.stg_fms_vendor(doc_dept_cd);
CREATE INDEX idx_doc_id_stg_fms_vendor   ON    etl.stg_fms_vendor(doc_id);
CREATE INDEX idx_doc_vers_no_stg_fms_vendor   ON    etl.stg_fms_vendor(doc_vers_no);
CREATE INDEX idx_uniq_id_stg_fms_vendor   ON    etl.stg_fms_vendor(uniq_id);


CREATE INDEX idx_doc_cd_stg_fms_accounting_line   ON    etl.stg_fms_accounting_line(doc_cd);
CREATE INDEX idx_doc_dept_cd_stg_fms_accounting_line   ON    etl.stg_fms_accounting_line(doc_dept_cd);
CREATE INDEX idx_doc_id_stg_fms_accounting_line  ON    etl.stg_fms_accounting_line(doc_id);
CREATE INDEX idx_doc_vers_no_stg_fms_accounting_line   ON    etl.stg_fms_accounting_line(doc_vers_no);
CREATE INDEX idx_uniq_id_stg_fms_accounting_line   ON    etl.stg_fms_accounting_line(uniq_id);
