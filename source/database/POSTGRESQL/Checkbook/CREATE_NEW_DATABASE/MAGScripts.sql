...
BEGIN
	...
	SELECT a.document_id,a.document_code_id, b.agency_id, 
		...
		group_concat(CASE WHEN a.document_version <> b.latest_version_no THEN master_agreement_id::varchar ELSE 0::varchar END) as non_latest_master_agreement_id,		
		group_concat(CASE WHEN a.document_version <> b.first_version_no THEN master_agreement_id::varchar ELSE 0::varchar END) as non_first_master_agreement_id
...
BEGIN
	...
	CREATE TEMPORARY TABLE tmp_rfed_loaded_master_agreements(master_agreement_id bigint,original_master_agreement_id bigint,doc_appl_last_dt date) ;
	...
	CREATE TEMPORARY TABLE tmp_rfed_matching_agreements(master_agreement_id bigint,document_id varchar, document_code_id smallint, agency_id smallint, document_version integer)  ;
	...
	CREATE TEMPORARY TABLE tmp_rfed_amounts_for_master(master_agreement_id bigint,rfed_amount numeric) ;
