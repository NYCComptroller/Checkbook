...
BEGIN
	...
	*/
	...
	SELECT a.document_id,a.document_code_id, b.agency_id, 
		...
		group_concat(CASE WHEN a.document_version <> b.latest_version_no THEN agreement_id::varchar ELSE 0::varchar END) as non_latest_agreement_id,		
		group_concat(CASE WHEN a.document_version <> b.first_version_no THEN agreement_id::varchar ELSE 0::varchar END) as non_first_agreement_id,
...
CREATE TEMPORARY TABLE tmp_ct_master_agreements_rfed(original_master_agreement_id bigint, status_flag char(1), fiscal_year smallint, rfed_amount numeric(16,2)) ;
