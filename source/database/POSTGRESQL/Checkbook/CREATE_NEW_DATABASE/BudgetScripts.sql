...
BEGIN
	...
	CREATE TEMPORARY TABLE tmp_budget_agency(agency_id integer,budget_fiscal_year smallint,budget_fiscal_year_id smallint, modified_budget_amount numeric (20,2)) ;
...
-- select object_class_code , agency_id,department_id,count(distinct budget_fiscal_year) from budget group by 1,2,3 having count(distinct budget_fiscal_year)>1
	...
	CREATE TEMPORARY TABLE tmp_budget_object(object_class_id integer,budget_fiscal_year smallint,budget_fiscal_year_id smallint, modified_budget_amount numeric (20,2)) ;
...
-----------------------
	...
	CREATE TEMPORARY TABLE tmp_budget_agency_object(agency_id integer,object_class_id integer,budget_fiscal_year smallint,budget_fiscal_year_id smallint, modified_budget_amount numeric (20,2)) ;
...
-----------------------
	...
	CREATE TEMPORARY TABLE tmp_budget_agency_dept(agency_id integer,department_code varchar,budget_fiscal_year smallint,budget_fiscal_year_id smallint, modified_budget_amount numeric (20,2)) ;
...
UPDATE aggregateon_budget_by_year a
	...
	CREATE TEMPORARY TABLE tmp_budget_agency_dept_obj(agency_id integer,department_code varchar,object_class_id integer,budget_fiscal_year smallint,budget_fiscal_year_id smallint, modified_budget_amount numeric (20,2)) ;
