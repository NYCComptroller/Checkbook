COPY etl.ref_data_source FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/ref_data_source.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_column_mapping FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/ref_column_mapping.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_validation_rule FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/ref_validation_rule.csv' CSV HEADER QUOTE as '"';

COPY etl.ref_file_name_pattern FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/ref_file_name_pattern.csv' CSV HEADER QUOTE as '"';

COPY etl.aggregate_tables FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/widget_aggregate_tables.csv' CSV HEADER QUOTE as '"';

COPY etl.aggregate_tables FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/widget_aggregate_tables_mwbe.csv' CSV HEADER QUOTE as '"';

COPY etl.aggregate_tables FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/widget_aggregate_tables_subcontracts.csv' CSV HEADER QUOTE as '"';
...
COPY etl.stg_funding_class FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/FundingClass.txt' DELIMITER AS '|' ESCAPE '~' FILL MISSING FIELDS;
...
COPY etl.stg_award_method FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/AwardMethod.csv' CSV QUOTE as '"' ;
...
COPY etl.stg_agreement_type FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/AgreementType.csv' DELIMITER AS ',' ;
...
COPY etl.stg_award_category FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/AgreementCategory.csv' CSV QUOTE as '"' ;
...
COPY etl.stg_award_category_industry FROM '/home/gpadmin/GREENPLUM/Checkbook/CREATE_NEW_DATABASE/AgreementIndustryCategory.csv' CSV QUOTE as '"' ;
