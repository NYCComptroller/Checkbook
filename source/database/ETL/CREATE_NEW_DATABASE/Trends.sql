...
COPY  trends_gen_fund_revenue_temp FROM '/home/gpadmin/ETL/TRENDS/trends_general_fund_revenues.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_gen_fund_expenditure_temp FROM '/home/gpadmin/ETL/TRENDS/trends_general_fund_expenditures.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_capital_projects_temp FROM '/home/gpadmin/ETL/TRENDS/trends_capital_projects.csv' CSV HEADER QUOTE as '"';
...
*/
COPY  trends_ratios_outstanding_debt_temp FROM '/home/gpadmin/ETL/TRENDS/trends_ratios_outstanding_debt.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_property_tax_levies_temp FROM '/home/gpadmin/ETL/TRENDS/trends_property_tax_levies.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_personal_income_temp FROM '/home/gpadmin/ETL/TRENDS/trends_personal_incomes.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_collection_cancellation_abatements_temp FROM '/home/gpadmin/ETL/TRENDS/trends_collection_cancellation_abatements.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_employment_status_of_resident_population_temp FROM '/home/gpadmin/ETL/TRENDS/trends_employment_status_of_resident_population.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_non_agricultural_wage_salary_employement_temp FROM '/home/gpadmin/ETL/TRENDS/trends_non_agricultural_wage_salary_employement.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_numberofcityemployees_temp FROM '/home/gpadmin/ETL/TRENDS/trends_numberofcityemployees.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_new_york_city_educational_construction_temp FROM '/home/gpadmin/ETL/TRENDS/trends_new_york_city_educational_construction.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_changes_in_fund_balances_temp FROM '/home/gpadmin/ETL/TRENDS/trends_changes_in_fund_balances.csv' CSV HEADER QUOTE as '"';
...
DISTRIBUTED BY (category);
	...
	COPY  trends_capital_assets_statistics_function_program_temp FROM '/home/gpadmin/ETL/TRENDS/trends_capital_assets_statistics_function_program.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_assesed_valuation_tax_rate_class_temp FROM '/home/gpadmin/ETL/TRENDS/trends_assesed_valuation_tax_rate_class.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_assesed_estimated_actual_taxable_property_temp FROM '/home/gpadmin/ETL/TRENDS/trends_assesed_estimated_actual_taxable_property.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_nyc_population_temp FROM '/home/gpadmin/ETL/TRENDS/trends_nyc_population.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_property_tax_temp FROM '/home/gpadmin/ETL/TRENDS/trends_property_tax.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_person_receiving_pubic_assistance_temp FROM '/home/gpadmin/ETL/TRENDS/trends_person_recieving_public_asssistance.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_pledged_revenue_temp FROM '/home/gpadmin/ETL/TRENDS/trends_pledged_revenue.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_uncollected_parking_violation_temp FROM '/home/gpadmin/ETL/TRENDS/trends_uncollected_parking_violation.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_changes_net_assets_temp FROM '/home/gpadmin/ETL/TRENDS/trends_changes_net_assets.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_government_funds_temp FROM '/home/gpadmin/ETL/TRENDS/trends_government_funds.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_hudson_yards_infrastructure_temp FROM '/home/gpadmin/ETL/TRENDS/trends_hudson_yards_infrastructure.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_legal_debt_margin_temp FROM '/home/gpadmin/ETL/TRENDS/trends_legal_debt_margin.csv' CSV HEADER QUOTE as '"';
...
COPY  trends_ratios_general_bonded_debt_outstanding_temp FROM '/home/gpadmin/ETL/TRENDS/trends_ratios_general_bonded_debt_outstanding.csv' CSV HEADER QUOTE as '"';
