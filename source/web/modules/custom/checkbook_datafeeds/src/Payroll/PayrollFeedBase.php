...
/**
 * Class PayrollFeedBase
 * @package checkbook_datafeeds
 */
abstract class PayrollFeedBase
{
  /**
   * @var string
   */
  ...
  public function process_confirmation($form, FormStateInterface &$form_state)
  {
    ...
    if ($this->data_source == Datasource::NYCHA) {
      $form_state->set(['step_information', 'payroll', 'stored_values', 'oge_column_select'], $this->filtered_columns);
    } else {
      $form_state->set(['step_information', 'payroll', 'stored_values', 'column_select'], $this->filtered_columns);
    }
    $modified_form = checkbook_datafeeds_end_of_confirmation_form($this->form, $this->form_state, $this->criteria, $this->response_type, CheckbookDomain::$PAYROLL);
  ...
  {
    $this->values = $this->form_state->get(['step_information', 'payroll', 'stored_values']);
  ...
  public function checkbook_datafeeds_payroll_validate(&$form, FormStateInterface &$form_state)
  {
