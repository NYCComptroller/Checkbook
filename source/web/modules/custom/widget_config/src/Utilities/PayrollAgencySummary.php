...
class PayrollAgencySummary
{
  ...
  public static function payrollEmpAgency($node)
  {
    ...
    $salaried_count = !empty($all_data[PayrollType::$SALARIED]) && is_array($all_data[PayrollType::$SALARIED]) ? count($all_data[PayrollType::$SALARIED]) : 0;
    $non_salaried_count = !empty($all_data[PayrollType::$NON_SALARIED]) && is_array($all_data[PayrollType::$NON_SALARIED]) ? count($all_data[PayrollType::$NON_SALARIED]) : 0;
