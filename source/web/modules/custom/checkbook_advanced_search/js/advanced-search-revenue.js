    ...
    'advanced_search_revenue_init': function () {
        let revenue_div = function (data_source, div_contents) {
          this.div_elements = {
            ...
            'conditional_categories': 'select[name=' + data_source + '_revenue_conditional_categories]',
        ...
        let onRevenueDataSourceChange = function (dataSource) {
          ...
          switch (dataSource) {
            ...
            default:
              ...
              div_checkbook_revenue.ele('conditional_categories').removeAttr('style');
              div_checkbook_revenue.ele('conditional_categories').removeAttr('disabled');
        ...
        function onRevenueBudgetFiscalYearChange(div) {
          ...
          if (data_source === 'checkbook') {
            ...
            updateConditionalEventValue(div.ele('conditional_categories'), budget_fiscal_year, false,'revenue');
          }
        }
        ...
        function onRevenueCatastrophicEventChange(div) {
          ...
          updateEventYearValue("select[name='checkbook_revenue_budget_fiscal_year'] option", cevent, 'revenue');
        }
        ...
        div_checkbook_revenue.ele('conditional_categories').change(function () {
          onRevenueCatastrophicEventChange(div_checkbook_revenue);
        });
