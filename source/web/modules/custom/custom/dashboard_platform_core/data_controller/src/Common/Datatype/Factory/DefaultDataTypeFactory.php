...
namespace Drupal\data_controller\Common\Datatype\Factory;
...
use Drupal\data_controller\Common\Object\Exception\IncompatibleDataTypeException;
...
class DefaultDataTypeFactory extends DataTypeFactory {
    ...
    public function __construct() {
        parent::__construct();
        $this->handlerConfigurations = \Drupal::moduleHandler()->invokeAll('dc_data_type');
    }
