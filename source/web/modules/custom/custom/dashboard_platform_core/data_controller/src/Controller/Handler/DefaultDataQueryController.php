...
use Drupal\data_controller\Controller\Request\DataQueryControllerCubeRequest;
use Drupal\data_controller\Controller\Request\DataQueryControllerDatasetRequest;
use Drupal\data_controller\Controller\Request\DataQueryControllerRequestTree;
...
class DefaultDataQueryController extends AbstractDataQueryController {
   ...
   * @throws UnsupportedOperationException
   */
  public function countRecords($request): ?int
  {
        $requestCleaner = new DataQueryControllerRequestCleaner();
        $adjustedRequest = $requestCleaner->adjustRequest($request);
  ...
  protected function executeDatasetQueryRequest(DataQueryControllerDatasetRequest $request) {
        ...
        $datasetResultFormatter = $request->resultFormatter ?? $this->getDefaultResultFormatter();
  ...
  protected function executeCubeCountRequest(DataQueryControllerCubeRequest $request) {
        ...
        LogHelper::log_notice("Printing Request ...".json_encode($request));
