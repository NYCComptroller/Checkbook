...
use Drupal\data_controller_sql\Datasource\Handler\Impl\AbstractDataSourceOwnerImpl;

class PostgreSQLDataSourceOwnerImpl extends AbstractDataSourceOwnerImpl {
