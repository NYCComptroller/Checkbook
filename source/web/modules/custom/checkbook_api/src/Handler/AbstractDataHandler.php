...
use Drupal\checkbook_api\Handler\DataSetHandler;
use Exception;
...
abstract class AbstractDataHandler {
  ...
  function validateRequest() {
    //var_dump("Start of validateRequest of AbstractDataHandler");
...
//var_dump($this->requestSearchCriteria);
//die();

    // Validate criteria:
    $this->requestSearchCriteria->validateCriteria();
//var_dump($this->requestSearchCriteria->hasErrors());
//die();//
    ...
    //var_dump("End of validateRequest of AbstractDataHandler");
    return $this->validRequest;
  }
  ...
  private function setRequestDataSet() {
    ...
    $data_set_handler = new \Drupal\checkbook_api\Handler\DataSetHandler($this->requestSearchCriteria, $configuration);
    $this->requestDataSet = $data_set_handler->prepareDataSet();
    //var_dump($this->requestDataSet );
    //die();
  }
