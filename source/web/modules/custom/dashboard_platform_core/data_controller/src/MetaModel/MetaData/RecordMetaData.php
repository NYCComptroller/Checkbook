...
use Drupal\data_controller\Common\Object\Comparator\MathHelper;
...
use Drupal\data_controller\Exception;
...
class RecordMetaData extends AbstractMetaData
{
  ...
  public function finalize()
  {
    ...
    SortHelper::sort_records($this->columns, new PropertyBasedComparator_DefaultSortingConfiguration('columnIndex'));
  }
