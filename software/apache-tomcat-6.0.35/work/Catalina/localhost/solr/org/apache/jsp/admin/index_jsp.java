...
boolean replicationhandler = !core.getRequestHandlers(ReplicationHandler.class).isEmpty();
 ...
 if (null != core.getSchemaResource()) { 
      out.write("\n");
      out.write("    [<a href=\"file/?contentType=text/xml;charset=utf-8&file=");
...
if(replicationhandler){
 ...
 out.write( org.apache.solr.handler.admin.ShowFileRequestHandler.getFileContents( "admin-extra.html" ) );
      ...
      out.write("        \tonclick=\"if (queryForm.q.value.length==0) { alert('no empty queries, please'); return false; } else { queryForm.submit(); return false;} \">\n");
      out.write("\t</form>\n");
      out.write("  </td>\n");
      out.write("</tr>\n");
      out.write("</table><p>\n");
